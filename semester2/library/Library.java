...
pw.print(c.username + attributeSep + c.fname + attributeSep + c.lname + attributeSep + c.password + attributeSep + c.bday.getYear() + attributeSep
...
if (attr.length == 8) {
Strings = attr[7].split(Pattern.quote("."));
}
